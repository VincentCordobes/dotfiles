# Generated by Powerlevel10k configuration wizard on 2021-05-01 at 19:25 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%2F'  # grey foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="%246F${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
    ...
    [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${meta}@%246F${VCS_STATUS_COMMIT[1,8]}"
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" %246F*${VCS_STATUS_STASHES}"
